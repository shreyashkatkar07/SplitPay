    ...
    <div className="container mx-auto py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          {users.length === 0 ? (
            <Card>
              <CardContent className="text-center py-6 text-muted-foreground min-h-[80px] flex items-center justify-center">
              ...
              {users.map((user) => (
                <Link key={user.id} href={`/person/${user.id}`}>
                  <Card className="hover:bg-muted/30 transition-colors cursor-pointer">
                    <CardContent className="py-4 min-h-[80px] flex items-center">
