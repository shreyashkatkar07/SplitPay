                    ...
                    <div className='flex flex-wrap gap-2 mb-2'>
                        ...
                        {selectedMembers.map((member) =>(
                            <Badge key={member.id} variant="secondary" className='px-3 py-1'>
                                ...
                                <button type='button' className='ml-2 text-muted-foreground hover:text-foreground' onClick={() => removeMember(member.id)}>
                                    <X className="h-3 w-3" />
                                </button>
                            </Badge>
                        ))}
                        ...
                        <Popover open={commandOpen} onOpenChange={setCommandOpen}>
                            <PopoverTrigger asChild>
                                <Button type="button" variant="outline" size="sm" className='h-8 text-sx gap-1'>
